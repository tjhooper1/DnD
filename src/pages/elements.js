                    ...
                    <div className="grid-wrapper">
                        <div className="col-6">
                            ...
                            <p>
                                ...
                                placerat aliquet. Volutpat commodo eu sed ante
                                lacinia. Sapien a lorem in integer ornare
                                praesent commodo adipiscing arcu in massa
                                commodo lorem accumsan at odio massa ac ac.
                        ...
                        <div className="col-6">
                            ...
                            <p>
                                In arcu accumsan arcu adipiscing accumsan orci
                                ac. Felis id enim aliquet. Accumsan ac integer
                                lobortis commodo ornare aliquet accumsan erat
                                tempus amet porttitor. Ante commodo blandit
                                adipiscing integer semper orci eget. Faucibus
                                commodo adipiscing mi eu nullam accumsan morbi
                                arcu ornare odio mi adipiscing nascetur lacus ac
                                interdum morbi accumsan vis mi accumsan ac
                                praesent.
                            </p>
                        </div>
                        <div className="col-4">
                    ...
                    <div className="grid-wrapper">
                        <div className="col-6">
                            ...
                            <p>
                                ...
                                <strong>strong</strong>. This is <i>italic</i>{' '}
                                and this is <em>emphasized</em>. This is{' '}
                            ...
                            <dl>
                                ...
                                <dd>
                                    <p>
                                        ...
                                        ac pellentesque praesent. Lorem ipsum
                                        dolor.
                                    </p>
                                </dd>
                                <dt>Item2</dt>
                            ...
                            <ul className="pagination">
                                <li>
                                    <span className="button small disabled">
                                        Prev
                                    </span>
                                </li>
                                <li>
                            ...
                            <blockquote>
                                ...
                                faucibus vestibulum. Blandit adipiscing eu
                                felis.
                            </blockquote>
                        ...
                        <div className="col-6">
                            ...
                            <ul className="actions">
                                <li>
                                    <span className="button special disabled">
                                        Special
                                    </span>
                                </li>
                                <li>
                            ...
                            <p>
                                ...
                                Vestibulum ante ipsum primis sagittis eget.
                                tempus euismod. Vestibulum ante ipsum primis in
                                faucibus vestibulum. Blandit adipiscing eu felis
                                iaculis volutpat ac adipiscing accumsan eu
                                faucibus. Integer ac pellentesque praesent
                                tincidunt felis sagittis eget tempus vestibulum
                                ante ipsum primis in faucibus magna blandit
                            ...
                            <div className="box">
                                <p>
                                    Felis sagittis eget tempus primis in
                                    faucibus vestibulum. Blandit adipiscing eu
                                    felis iaculis volutpat ac adipiscing
                                    accumsan eu faucibus. Integer ac
                                    pellentesque praesent tincidunt felis
                                    sagittis eget. tempus euismod. Magna sed
                                    etiam ante ipsum primis in faucibus
                                    vestibulum. Blandit adipiscing eu ipsum
                                    primis in faucibus vestibulum. Blandit
                                    adipiscing eu felis iaculis volutpat ac
                            ...
                            <pre>
                                <code>
                                    i = 0; print 'It took ' + i + ' iterations
                                    to sort the deck.';
                                </code>
                            </pre>
                        </div>
